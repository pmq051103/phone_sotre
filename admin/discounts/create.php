<?php
$pageTitle = 'Thêm mã giảm giá - Admin';
            ...
            try {
                ...
                if ($isStaff) {
                    $approvalId = createApproval($conn, [
                        ...
                        'entity_id' => null,
                        'payload' => $data, // Gửi toàn bộ data
                    ]);

                    setFlash('success', "Đã gửi yêu cầu thêm mã giảm giá (#$approvalId). Chờ admin phê duyệt.");
                    redirect(BASE_URL . '/admin/discounts/list.php');
                    exit;
                }

                // ================= ADMIN: insert thật (MySQLi) =================
                ...
                setFlash('success', 'Đã thêm mã giảm giá.');
                redirect(BASE_URL . '/admin/discounts/list.php');
                exit;
...
<main class="admin-main">
    <div class="admin-topbar">
        <div>
            <div class="admin-title">Thêm mã giảm giá</div>
            <div class="admin-sub">Thiết lập loại giảm, min/max, số lượt, thời gian…</div>
        </div>
            ...
            <form method="POST">
                ...
                <div style="display:flex;justify-content:flex-end;gap:10px;margin-top:16px;">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-save"></i> <?= $isStaff ? 'Gửi phê duyệt' : 'Lưu' ?>
                    </button>
                </div>
            </form>
        </div>
